    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.span
            className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-36 h-[2px] bg-primary rounded-full shadow-[0_0_12px_rgba(59,130,246,0.6)]"
        ...
        <motion.p
          className="text-center text-gray-400 text-[13px] sm:text-[15px] md:text-basetext-muted-foreground mb-4 max-w-xl lg:max-w-2xl mx-auto leading-relaxed"
          {...fadeLeft(0.25)}
        >
